...
### <b>Jogos Lançados</b>
```{r}
valueBox(total_jogos, icon = "ion-steam")
```

### <b>Jogos para Windonws</b>
```{r}
valueBox(nrow(total_w), icon = "ion-social-windows")
```

### <b>Jogos para Linux</b>
```{r}
valueBox(nrow(total_l), icon = "ion-social-tux")
```

### <b>Jogos para Mac</b>
```{r}
valueBox(nrow(total_m), icon = "ion-social-apple")
```
